...
export const menu: MenuCategory[] = [
  {
    ...
    name: "Desi Salan",
    items: [
      { name: "Chana", half: "Rs. 150", full: "Rs. 200",  image:Chana  },
      { name: "Murgh Chana", half: "Rs. 200", full: "Rs. 300",  image:MurghChana },
      { name: "Anda Chana", half: "Rs. 150", full: "Rs. 250",  image:AndaChana },
      { name: "Aloo Qeema", half: "Rs. 200", full: "Rs. 400",  image:AlooQeema },
      { name: "Chana Haleem", half: "Rs. 200", full: "Rs. 300",  image:Haleem },
      { name: "Mix Sabzi", half: "Rs. 150", full: "Rs. 200", image:MixSabzi },
      { name: "Daal Chana", half: "Rs. 150", full: "Rs. 200",  image:DaalChana },
      { name: "Daal Mash", half: "Rs. 150", full: "Rs. 200",  image: DaalMash },
      { name: "Chicken Qorma", half: "Rs. 200", full: "Rs. 400", image: ChickenQorma },
      { name: "Daal Lobia", half: "Rs. 150", full: "Rs. 200",  image: DaalLobia },
      { name: "Mix Daal", half: "Rs. 150", full: "Rs. 200",image: MixDaal },
      { name: "Curry Pakora", half: "Rs. 150", full: "Rs. 200",image: CurryPakora },
      { name: "Tawa Kaleeji", half: "Rs. 200", full: "Rs. 400", image: TawaKaleeji },
    ],
  },
  {
    id: "channay",
    name: "Chai & Breakfast",
    items: [
      { name: "Chai", price: "Rs. 60", image: Chai },
      { name: "Shakar Chai", price: "Rs. 70", image: ShakarChai },
      { name: "Special Chai", price: "Rs. 100", image: SpecialChai },
      { name: "Kashmiri Chai", price: "Rs. 150", image: KashmiriChai },
      { name: "Green Tea", price: "Rs. 60", image: GreenTea },
      { name: "Paratha", price: "Rs. 60", image: Paratha },
      { name: "Aloo Paratha", price: "Rs. 100", image: AlooParatha },
      { name: "Omelette Paratha", price: "Rs. 150", image: OmeletteParatha },
      { name: "Tandoori Paratha", price: "Rs. 80", image: TandooriParatha },
      { name: "Anda Fry", price: "Rs. 60", image: AndaFry },
      { name: "Anda Omelette", price: "Rs. 80", image: AndaOmelette },
      { name: "Lassi", price: "Rs. 180", image: Lassi },
    ],
  },
  {
    id: "tandoor",
    name: "Tandoor",
    items: [
      { name: "Naan", price: "Rs. 25", image: Naan },
      { name: "Roti", price: "Rs. 20", image: Roti },
      { name: "Roghni Naan", price: "Rs. 60", image: RoghniNaan },
      { name: "Kulcha", price: "Rs. 30", image: Kulcha },
    ],
  },
  {
    id: "chicken-karahi",
    name: "Chicken Karahi",
    items: [
      { name: "Chicken Karahi", half: "Rs. 1,000", full: "Rs. 1,800", image: ChickenKarahi },
      { name: "White Chicken Karahi", half: "Rs. 1,200", full: "Rs. 2,000", image: WhiteChickenKarahi },
      { name: "Chicken Makhni Karahi", half: "Rs. 1,300", full: "Rs. 2,500", image: ChickenMakhni },
    ],
  },
  {
    id: "biryani",
    ...
    items: [
      { name: "Chicken Single Biryani", price: "Rs. 170", image: ChickenBiryani },
      { name: "Chicken Full Biryani", price: "Rs. 350", image: ChickenBiryani },
      { name: "Single Biryani", price: "Rs. 150", image: ChickenBiryani },
      { name: "Full Biryani", price: "Rs. 300", image: ChickenBiryani },
      { name: "Single Pulao", price: "Rs. 150", image: Pulao },
      { name: "Full Pulao", price: "Rs. 300", image: Pulao },
    ],
  },
  {
    id: "bbq",
    name: "BBQ",
    items: [
      { name: "Chicken Kabab", single: "Rs. 150", halfDozen: "Rs. 800", fullDozen: "Rs. 1,600", image: ChickenReshmiKabab },
      { name: "Chicken Reshmi Kabab", single: "Rs. 200", halfDozen: "Rs. 1,100", fullDozen: "Rs. 2,200", image: ChickenReshmiKabab },
      { name: "Chicken Turkish Kabab", single: "Rs. 200", halfDozen: "Rs. 1,100", fullDozen: "Rs. 2,200", image: ChickenTurkishKabab },
      { name: "Chicken Boti", single: "Rs. 200", halfDozen: "Rs. 1,100", fullDozen: "Rs. 2,200", image: ChickenBoti },
      { name: "Chicken Malai Boti", single: "Rs. 220", halfDozen: "Rs. 1,200", fullDozen: "Rs. 2,400", image: ChickenMalaiBoti },
      { name: "Chicken Tikka Leg Pieces", single: "Rs. 320", halfDozen: "Rs. 1,800", fullDozen: "Rs. 3,600", image: ChickenTikka },
      { name: "Chicken Chest Pieces", single: "Rs. 350", halfDozen: "Rs. 2,000", fullDozen: "Rs. 4,000", image: ChickenChest },
    ],
  },
  {
    id: "drinks",
  ...
  },
  {
    ...
    name: "Side Orders",
    items: [
      { name: "Fresh Salad", price: "Rs. 30",  image: Salad },
      { name: "Mint Raita", price: "Rs. 30",  image: Raita },
      { name: "Shami Kabab", price: "Rs. 50", image: Shami },
    ],
  },
  {
    id: "deals",
    name: "Deals",
    items: [
      { name: "Zaiqah Deal 1", price: "Rs. 1,050", desc: "Full Biryani + 2 Kabab + 4 Chicken Boti + 4 Malai Boti + 2 Roti/Naan + Raita + Salad + 1L Drink.", image: Deal1 },
      { name: "Zaiqah Deal 2", price: "Rs. 2,050", desc: "2 Full Biryani + 4 Kabab + 8 Chicken Boti + 8 Malai Boti + 4Roti/Naan + Raita + Salad + 1.5L Drink.", image: Deal2 },
    ],
  },
];
